...
use App\Http\Controllers\LaporanController; // Mengubah 'App\Http\Controller\LaporanController' menjadi 'App\Http\Controllers\LaporanController'
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('cart', CartController::class)->except('create', 's
    how', 'edit')
    ...
    Route::get('/laporan/petugas', [LaporanController::class, 'laporanPetugas'])->name('laporan.petugas');
