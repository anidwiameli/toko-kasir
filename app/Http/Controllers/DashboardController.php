...
class DashboardController extends Controller
{
    function index()
    {
        ...
        return view('welcome', [
            'user' => $user ?? null, // Memastikan bahwa variabel $user didefinisikan
            'pelanggan' => $pelanggan,
            'kategori' => $kategori,
            'produk' => $produk,
            'cart' => [
            ...
            'error' => !isset($user) // Menambahkan variabel error untuk menangani kasus ketika tidak ada data pengguna
        ]);        
    }
}
